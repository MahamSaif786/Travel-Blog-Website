...
// Define the LinkedinIconProps interface
interface MoonIconProps extends React.SVGProps<SVGSVGElement> {
  className?: string;
}
export const MoonIcon: React.FC<MoonIconProps> = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
...
export const GithubIcon: React.FC<GithubIconProps> = ({ className, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
...
interface DribbbleIconProps extends React.SVGProps<SVGSVGElement> {
  className?: string;
}
export const DribbbleIcon: React.FC<DribbbleIconProps> = ({ className, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
